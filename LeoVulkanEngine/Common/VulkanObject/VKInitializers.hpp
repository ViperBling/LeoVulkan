...
namespace LeoVK::Init
{
    ...
    inline VkCommandBufferInheritanceInfo CmdBufferInheritanceInfo()
    {
    ...
    inline VkMemoryBarrier MemoryBarriers()
    {
    ...
    inline VkDescriptorPoolCreateInfo DescPoolCreateInfo(
    ...
    inline VkDescriptorPoolSize DescPoolSize(
    ...
    inline VkDescriptorSetLayoutBinding DescSetLayoutBinding(
        VkDescriptorType type,
    ...
    inline VkDescriptorSetLayoutCreateInfo DescSetLayoutCreateInfo(
    ...
    inline VkDescriptorSetAllocateInfo DescSetAllocateInfo(
    ...
    inline VkDescriptorImageInfo DescImageInfo(VkSampler sampler, VkImageView imageView, VkImageLayout imageLayout)
    {
    ...
    inline VkVertexInputBindingDescription VIBindingDescription(
        uint32_t binding,
        uint32_t stride,
    ...
    inline VkVertexInputAttributeDescription VIAttributeDescription(
        uint32_t binding,
        uint32_t location,
        VkFormat format,
        uint32_t offset)
    ...
    inline VkPipelineVertexInputStateCreateInfo PipelineVIStateCreateInfo()
    {
    ...
    inline VkPipelineInputAssemblyStateCreateInfo PipelineIAStateCreateInfo(
    ...
    inline VkPipelineRasterizationStateCreateInfo PipelineRSStateCreateInfo(
    ...
    inline VkPipelineColorBlendAttachmentState PipelineCBAState(
    ...
    inline VkPipelineColorBlendStateCreateInfo PipelineCBStateCreateInfo(
    ...
    inline VkPipelineDepthStencilStateCreateInfo PipelineDSStateCreateInfo(
    ...
    inline VkPipelineViewportStateCreateInfo PipelineVPStateCreateInfo(
    ...
    inline VkPipelineMultisampleStateCreateInfo PipelineMSStateCreateInfo(
    ...
    inline VkPipelineDynamicStateCreateInfo PipelineDYStateCreateInfo(
    ...
    inline VkPipelineTessellationStateCreateInfo PipelineTSStateCreateInfo(uint32_t patchControlPoints)
    {
    ...
    // Ray tracing related
    inline VkAccelerationStructureGeometryKHR AccStructureGeometryKHR()
    {
    ...
    inline VkAccelerationStructureBuildGeometryInfoKHR AccStructureBuildGeometryInfoKHR()
    {
    ...
    inline VkAccelerationStructureBuildSizesInfoKHR AccStructureBuildSizesInfoKHR()
    {
    ...
    inline VkWriteDescriptorSetAccelerationStructureKHR WriteDescriptorSetAccStructureKHR()
    {
